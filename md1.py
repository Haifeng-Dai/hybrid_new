...
#     n_client=n_client,
# )
train_set = SplitData(data_set.train_set).server_non_iid(num_server=3,
                                        num_server_client=3,
                                        num_client_data=n_train_data,
                                        client_main_target=[1, 3, 5])
test_set = SplitData(data_set.train_set).server_non_iid(num_server=3,
                                        num_server_client=3,
                                        num_client_data=n_train_data,
                                        client_main_target=[1, 3, 5])
...
for i, dataset_ in enumerate(test_set):
...
for i, dataset_ in enumerate(train_set):
...
save_path = f'./res/md1_seed{seed}_alpha_{alpha}_dataset_{dataset}_model_structure_{model_structure}/'
file_name = save_path + \
    f'a_{a}_' + \
